...
const createGetChatTokenEndpoint = (liveChatVersion: LiveChatVersion, auth: boolean, copilotBotPresent?: boolean): string => {
  ...
  if (copilotBotPresent){
    return auth? OmnichannelEndpoints.LiveChatv4AuthGetChatTokenPath: OmnichannelEndpoints.LiveChatv4GetChatTokenPath;
  }
